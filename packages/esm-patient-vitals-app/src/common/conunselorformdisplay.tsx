...
// conunselorformdisplay: similar to FormDisplay but labeled for the counselor form
export function ConunselorFormDisplay({
  formDefinition,
  answers,
}: {
  formDefinition: any;
  ...
  // Collect all questions (no hidden label filtering) so the counselor form displays every question
  ...
  function handleDownloadPDF() {
    ...
    let y = 20;
    doc.setFontSize(16);
    doc.text('काउन्सिलर फारम - उत्तरहरू', 15, y);
    y += 10;
    doc.setFontSize(12);
    ...
    doc.save('counselor-form-responses.pdf');
  }

  return (
    <div style={{ padding: '16px' }}>
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
        <h3 style={{ margin: 0, fontWeight: 'bold', fontSize: '1.3em' }}>काउन्सिलर फारम - उत्तरहरू</h3>
      </div>
...
export default ConunselorFormDisplay;
